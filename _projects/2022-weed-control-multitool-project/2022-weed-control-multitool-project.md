...
description: >
  ...
  multi-tool suitable for use in resource-constrained and rural communities.
skills:
...
## Project Overview
This project was completed in 2022 as part of the *Intro to Engineering Design* course
under the Engineers Without Borders (EWB) Challenge. The objective was to design a
...
- Developing a manually operated weed removal solution  
- Minimising cost and material complexity  
...
A structured engineering design methodology was followed throughout the project:
...
{% include image-gallery.html images="https://lh3.googleusercontent.com/d/1MpP8sq6NhpdWpxT_XNQbOOKTUhZXiWRT=w800-p, https://lh3.googleusercontent.com/d/1UyHwbZ5oma0T6zksvn1QB1s7F_UulBxe=w800-p, https://lh3.googleusercontent.com/d/1B5meD9ZDKAu5JV9CsPxEwqNOpikd8qNv, https://lh3.googleusercontent.com/d/1jV76y2-zk0YGCRJGMVtReuWwpSa0pfch=w800-p" height="500" %}
